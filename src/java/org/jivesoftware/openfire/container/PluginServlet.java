    ...
    public static void registerServlets( PluginManager manager, final Plugin plugin, File webXML)
    {
        ...
        try
        {
            ...
            for ( final String servletName : servletNames )
            {
                ...
                final String className = WebXmlUtils.getFilterClassName( webXmlDoc, servletName );
                ...
                final Set<String> urlPatterns = WebXmlUtils.getFilterUrlPatterns( webXmlDoc, servletName );
