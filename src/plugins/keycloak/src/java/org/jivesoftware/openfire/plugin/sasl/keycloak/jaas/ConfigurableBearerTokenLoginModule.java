...
/**
 * An extension of org.keycloak.adapters.jaas.BearerTokenLoginModule that can be configured dynamically, rather than
 * through a static config file.
 *
 * @author Guus der Kinderen, guus@goodbytes.nl
 */
public class ConfigurableBearerTokenLoginModule extends BearerTokenLoginModule
{
    private static final Logger Log = LoggerFactory.getLogger( ConfigurableBearerTokenLoginModule.class );
